...
Let Developer use a skill-installer or skill-search capability when it needs to find missing skills. Let Developer use a context-maintenance skill (if installed) when its triggers apply.
